...
Each flashcard must have difficulty level based on concept complexity.
Return as JSON: {"topic": "${topic}", "flashcards": [{"question": "...", "answer": "...", "difficulty": "easy/medium/hard"}]}`;
